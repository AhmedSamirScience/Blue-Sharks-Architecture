################################################################################################
# 👇 DataBinding Rule: Keep DataBinding-generated classes for the remotedata feature module
################################################################################################
...
# What this rule does:
# - Keeps all classes under `com.samir.bluearchitecture.remotedata.databinding`
...
# Safe and minimal — scoped to DataBinding only for remotedata module.
...
# ✅ WHAT IT DOES:
# - Prevents removal or renaming of any class under `com.samir.bluearchitecture.remotedata.main.di`
...
# - Especially when using R8 shrinking in each feature module (like remotedata)

-keep class com.samir.bluearchitecture.remotedata.main.di.** { *; }
################################################################################################



################################################################################################
# 🧩 Keep Class Names in remotedata.main (but allow shrink/obfuscation of internals)
#
# 🔎 WHY:
